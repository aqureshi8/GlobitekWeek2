...
<div id="main-content">
  ...
  <?php
    ...
    while($state = db_fetch_assoc($state_result)) {
      ...
      echo "<td>";
      echo "<a href=\"" . htmlspecialchars(rawurlencode("show.php") . "?id=" . urlencode($state['id'])) . "\">Show</a>";
      echo "</td>";
      echo "<td>";
      echo "<a href=\"" . htmlspecialchars(rawurlencode("edit.php") . "?id=" . urlencode($state['id'])) . "\">Edit</a>";
      echo "</td>";
      echo "</tr>";
    } // end while $states
