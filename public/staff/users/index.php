...
<div id="main-content">
  ...
  <?php
    ...
    while($user = db_fetch_assoc($users_result)) {
      ...
      echo "<td>";
      echo "<a href=\"" . htmlspecialchars(rawurlencode("show.php") . "?id=" . urlencode($user['id'])) . "\">Show</a>";
      echo "</td>";
      echo "<td>";
      echo "<a href=\"" . htmlspecialchars(rawurlencode("edit.php") . "?id=" . urlencode($user['id'])) . "\">Edit</a>";
      echo "</td>";
      echo "</tr>";
    } // end while $user
